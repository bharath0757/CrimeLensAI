...
app/
  ...
  repositories/
    graph_repository.py  # Parameterized Cypher operations
  services/
  ...
  store.py               # InMemoryGraphStore / Neo4jGraphStore
...
- Graph Data Science plugin (optional, for enhanced centrality/community detection)
